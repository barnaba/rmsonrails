...
class AttendeesControllerTest < ActionController::TestCase
  ...
  test "should create attendee" do
    assert_difference('Attendee.count') do
      post :create, attendee: { Email: @attendee.Email, Surname: @attendee.Surname, kotik_mailing: @attendee.kotik_mailing, name: @attendee.name }
    end
  ...
  test "should update attendee" do
    put :update, id: @attendee, attendee: { Email: @attendee.Email, Surname: @attendee.Surname, kotik_mailing: @attendee.kotik_mailing, name: @attendee.name }
    assert_redirected_to attendee_path(assigns(:attendee))
  end
